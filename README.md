...
`call-notes` v0.2：已吸收两个用户最终交付案例，覆盖交易推进和专题信息整理。按当前交付目的筛选内容，保留关键条件、判断依据与有价值的明细，并区分会议说法、背景解释和推断；精简范围，不一律压短。尚未验证新录音到满意终稿的完整效果。入口见 [专业电话会纪要](skills/call-notes/SKILL.md)。
