...
- Historical samples and user revisions have been distilled. Check `skills/report/references/profile.md` for current coverage and `evidence.md` for provenance. Never invent samples, preferences, outcomes, or evidence; distinguish user revisions of assistant drafts from independently authored samples.
